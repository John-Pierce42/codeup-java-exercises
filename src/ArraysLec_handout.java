...
//        System.out.println("prices[0] = " + prices[01]);
...
//
//        int[] sideArray = new int[diceSides];
//        System.out.println("diceSides = " + diceSides);
        ...
        String [] fruits = {"grapes", "oranges", "apples"};
        ...
        for(int i = 0; i < fruits.length; i++){
            System.out.println("these are my favorite fruits: " + fruits[i]);
        }
        System.out.println();

        for(String fruit : fruits){
            System.out.println("these are my favorite fruits: " + fruit);
        }
